...
<body class="h-screen bg-blue-100 flex items-center">
    ...
    <div class="flex bg-white items-center shadow-xl m-auto w-2/3 rounded-xl p-4">
        ...
        <div class="w-full">
            ...
            <p class="text-slate-500 text-center">Please login into your Admin account</p>
            <form class="flex flex-col p-2" action="{{ route('admin.post.login') }}" method="post">
                @csrf
            ...
            <p class="text-center text-slate-500">Don't have an Admin account ? <a class="text-yellow-500 font-bold"
                    href="{{ route('admin.register') }}">Signup</a></p>
        </div>
