    ...
    <div class="m-2 p-2 bg-slate-100 rounded-xl">
        ...
        <div class="flex justify-end">
            ...
            <button data-modal-target="default-modal" data-modal-toggle="default-modal"
                ...
                type="button">
                <i class="fa-regular fa-pen-to-square"></i> Add New Category
            </button>
        </div>
                ...
                <tbody>
                    @forelse ($categories as $item)
                        <tr
                            ...
                            <td class="px-6 py-4">
                                <img src="{{ asset('storage/' . $item->categoryImg) }}" alt="Product Image"
                            ...
                            <td class="px-6 w-full py-4 flex flex-col gap-2">
                                <a class="bg-blue-500 text-white text-center p-2 rounded-xl font-semibold"
                                    href="{{ url('/edit/category/' . $item->id) }}">Edit</a>

                                <form action="{{ url('/delete/category/' . $item->id) }}" method="post"
                                    class="cursor-pointer">
                                    @csrf
                                    @method('DELETE')
                                    <input class="bg-red-500 text-white w-full p-2 rounded-xl font-semibold" type="submit"
                                        value="Delete">
                                </form>
                            </td>
                        </tr>
            ...
            <div class="relative p-4 w-full max-w-2xl max-h-full">
                ...
                <div class="relative bg-white rounded-lg shadow dark:bg-gray-700">
                    ...
                    <div class="p-4 md:p-5 space-y-4">
                        ...
                        <form action="{{ url('/store/category') }}" method="post" class="flex flex-col gap-2"
                            enctype="multipart/form-data">
                            @csrf

                            <label for="name" class="font-semibold" class="font-semibold">Name</label>
                            ...
                            <label for="categoryImg" class="font-semibold">Category Images</label>
                            <input type="file" name="categoryImg" placeholder="Category Images"
                                class="p-2 rounded-xl bg-slate-100">

                            <label for="description" class="font-semibold">Category Description</label>
                            <div class="m-2">
