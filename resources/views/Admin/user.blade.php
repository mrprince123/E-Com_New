    ...
    <div class="m-2 p-2 bg-slate-100 rounded-xl">
        ...
        <div class="flex justify-end">
            ...
            <button data-modal-target="default-modal" data-modal-toggle="default-modal"
                ...
                type="button">
                <i class="fa-regular fa-pen-to-square"></i> Add New User
            </button>
        </div>
                ...
                <tbody>
                    @forelse ($users as $item)
                        <tr
                            ...
                            <td class="px-6 py-4">
                                <img src="{{ asset('storage/' . $item->profilePic) }}" alt="Product Image"
                            ...
                            <td class="px-6 py-4 flex flex-col gap-2">
                                ...
                                <a class="bg-blue-500 text-white text-center p-2 rounded-xl font-semibold"
                                    href="{{ url('/profile/edit/' . $item->id) }}">Edit</a>

                                <form action="{{ url('/profile/delete/' . $item->id) }}" method="post" class="">
                                    @csrf
                                    @method('DELETE')
                ...
                <div class="relative bg-white rounded-lg shadow dark:bg-gray-700">
                    ...
                    <div class="p-4 md:p-5 space-y-4">
                        ...
                        <form action="{{ url('/store/product') }}" method="post" class="flex flex-col gap-2">
                            ...
                            <label for="product_pic">Select Category</label>
                            ...
                            <label for="detail_description">Details Description</label>
