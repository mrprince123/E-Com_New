    ...
    <div class="m-2 p-2 bg-slate-100 rounded-xl">
        ...
        <div class="flex justify-end">
            ...
            <button data-modal-target="default-modal" data-modal-toggle="default-modal"
                ...
                type="button">
                <i class="fa-regular fa-pen-to-square"></i> Add New Caption
            </button>
        </div>
                        ...
                        <tr
                            ...
                            <td class="px-6 py-4 flex flex-col gap-2">
                                ...
                                <a class="bg-blue-500 text-white text-center p-2 rounded-xl font-semibold"
                                    href="{{ url('/edit/carousel/' . $item->id) }}">Edit</a>

                                <form action="{{ url('/delete/carousel/' . $item->id) }}" method="post" class="">
                                    @csrf
                                    @method('DELETE')
            ...
            <div class="relative p-4 w-full max-w-2xl max-h-full">
                ...
                <div class="relative bg-white rounded-lg shadow dark:bg-gray-700">
                    ...
                    <div class="p-4 md:p-5 space-y-4">
                        ...
                        <form action="{{ url('/store/carousel') }}" method="post" class="flex flex-col gap-2"
                            enctype="multipart/form-data">
                            @csrf

                            <label for="image">Carousel Images</label>
                            ...
                            <textarea name="caption" class="p-2 rounded-xl bg-slate-100" cols="20" rows="10" placeholder="Enter Caption"></textarea>


                            <input type="submit" value="Add New Caption"
